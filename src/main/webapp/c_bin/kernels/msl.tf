...
<!-- saved from url=(0055)http://naif.jpl.nasa.gov/pub/naif/MSL/kernels/fk/msl.tf -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">KPL/FK
...
-------------------------------------------------
   ...
   definition below was computed using the CAHVOR(E) camera model file,
   'MSL_CAL_004_SN_0215-NAVL-FLIGHT-RCE-B.cahvor'. According to this
   model the reference frame, MSL_RSM_HEAD, can be transformed into the
   camera frame, MSL_NAVCAM_LEFT_B, by the following sequence of
   rotations: first by 89.78164116 degrees about Y, then by -0.34767304
   degrees about X, and finally by -90.02351781 degrees about Z.
   ...
   \begindata
      ...
      TKFRAME_-76233_AXES             = (    2,        1,        3     )
      TKFRAME_-76233_ANGLES           = (  -89.782,    0.348,   90.024 )
   ...
   frame definition below was computed using the CAHVOR(E) camera model
   file, 'MSL_CAL_004_SN_0218-NAVR-FLIGHT-RCE-B.cahvor'. According to
   this model the reference frame, MSL_RSM_HEAD, can be transformed
   into the camera frame, MSL_NAVCAM_RIGHT_B, by the following sequence
   of rotations: first by 89.99312436 degrees about Y, then by
   -0.37620696 degrees about X, and finally by -90.29094535 degrees
   about Z.
   ...
   \begindata
      ...
      TKFRAME_-76234_AXES             = (    2,        1,        3     )
      TKFRAME_-76234_ANGLES           = (  -89.993,    0.376,   90.291 )
