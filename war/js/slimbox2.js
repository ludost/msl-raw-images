...
(function($) {
	...
	*/
	...
	function animateBox() {
		center.className = "";
		preload.width=Math.min(preload.width,options.initialWidth);
		preload.height=Math.min(preload.height,options.initialHeight);
		$(image).css({backgroundImage: "url(" + activeURL + ")", visibility: "hidden", display: "", "background-size":"contain"})
